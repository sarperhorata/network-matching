...
export function Dashboard({ onNavigate }: DashboardProps) {
  ...
  const loadAnalytics = async () => {
    ...
    try {
      const response = await api.getUserAnalytics(session.access_token);
  ...
  const stats = [
    ...
    },
    {
      ...
      value: analytics?.acceptedMatches || 0,
  ...
  const matchStatusData = [
    { name: 'Kabul Edildi', value: analytics?.acceptedMatches || 0, color: '#10b981' },
    { name: 'Beklemede', value: (analytics?.totalMatches || 0) - (analytics?.acceptedMatches || 0), color: '#f59e0b' },
  ];
  ...
  return (
    <div className="container mx-auto py-8 px-4 space-y-8">
      {/* Welcome Section */}
      <div>
        <h1 className="text-3xl mb-2">Hoş geldin, {user?.name}!</h1>
        ...
        <CardContent>
          <div className="space-y-2">
            <div className="flex justify-between text-sm">
              ...
              <span>{analytics?.profileCompletion || 0}%</span>
            </div>
        ...
        <CardContent>
          <div className="grid md:grid-cols-3 gap-4">
            <button
              ...
              className="p-6 border-2 rounded-lg hover:border-blue-600 transition-colors text-left"
            >
              <Calendar className="h-8 w-8 text-blue-600 mb-2" />
              <h3 className="mb-1">Etkinlikleri Keşfet</h3>
            ...
            >
              ...
              <h3 className="mb-1">Eşleşmeleri Gör</h3>
              <p className="text-sm text-gray-600">
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-start gap-3 p-3 bg-[#0EA5E9]/10 rounded-lg">
                ...
                <div>
                  <p className="text-sm">Yeni etkinliğe katıldınız</p>
              ...
              <div className="flex items-start gap-3 p-3 bg-[#8B5CF6]/10 rounded-lg">
                ...
                <div>
                  <p className="text-sm">5 yeni eşleşme önerisi</p>
              ...
              <div className="flex items-start gap-3 p-3 bg-[#10B981]/10 rounded-lg">
                ...
                <div>
                  <p className="text-sm">Yeni mesajınız var</p>
      ...
      {user?.role === 'organizer' && (
        <Card>
          <CardHeader>
            <CardTitle>Organizatör Paneli</CardTitle>
            <CardDescription>Etkinliklerinizi yönetin</CardDescription>
          </CardHeader>
          <CardContent>
            <button
              onClick={() => onNavigate('create-event')}
              className="w-full p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-[#0EA5E9] hover:bg-[#0EA5E9]/10 transition-all"
            >
              <span className="text-[#0EA5E9]">+ Yeni Etkinlik Oluştur</span>
            </button>
          </CardContent>
        </Card>
      )}
